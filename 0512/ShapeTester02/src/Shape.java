 ...
 * 추상 클래스이기 때문에 이 클래스의 인스턴스를 생성할 수 는 없습니다.
...
public abstract class Shape {
	 ...
	 * 클래스로부터 파생되는 클래스이고, 이 메소드의 본체를 구현합니다.
	 * 이 메소드는 java.lang.Object클래스의 메소드를 추상메소드로
	 * 오버라이드한 메소드입니다.
	 */
	 ...
	 * Step1. 메소드 toString이 반환하는 문자열을 표시해서 줄 바꿈. <BR>
	 * Step2. 메소드 draw를 호출한 도형의 그리기. <BR>
	 */
	public void print(){
